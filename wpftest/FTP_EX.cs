...
namespace WizMes_Alpha_JA
{
	public class FTP_EX
	{
        ...
        // 결재등록 화면 도장 다운로드
        /* Download File */
        public bool StempDownload(string remoteFile, string localFile, string name)
        {
            try
            {
                /* Create an FTP Request */
            ...
            {
                //System.Windows.MessageBox.Show(name + "님의 도장이미지가 존재하지 않습니다." + "\r(" + ex.Message + ")");
                return false;
            }
        }
